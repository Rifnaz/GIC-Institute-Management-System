<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="courses.aspx.cs" Inherits="GIC_IMS.admin.courses" %>
                ...
                <div class="col-sm-6 col-md-9 form-section">
                    <div class="table-responsive">
                        <div class="table-wrapper">
                            <table >
                                <asp:DataList class="table" ID="dtlCourse" RepeatColumns="7" runat="server">
                                    <HeaderTemplate>
                                        <tr>
                                    ...
                                    <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%#Eval("Lecturer") %></td>
                                                <td>
                                                    <a  href="student_details.aspx?id=<%#Eval("CourseID")%>" title="View" data-toggle="tooltip"><i class="material-icons">&#xe8f4;</i></a>
                                                    <asp:LinkButton ID="lbtnEdit" runat="server" class="edit" CommandArgument='<%#Eval("CourseID") %>' title="Edit" data-toggle="tooltip" OnClick="lbtnEdit_Click1"><i class="material-icons">&#xE254;</i></asp:LinkButton>
                                                    <asp:LinkButton ID="lbtnDelete" runat="server" class="delete" CommandArgument='<%#Eval("CourseID") %>' title="Delete" data-toggle="tooltip" OnClick="lbtnDelete_Click1"><i class="material-icons">&#xE872;</i></asp:LinkButton>
                                                </td>
                                            </tr>       
                                     </ItemTemplate>
                                </asp:DataList>
                  ...
                  <div class="col-sm-6 col-md-3 form-section">
                    <div class="login-wrapper">
                        <div class="form-group">
                            <asp:TextBox ID="txtName" runat="server" class="form-control" placeholder="Course"></asp:TextBox>
                        </div>
                        <div class="form-group">
                          <asp:TextBox ID="txtSemi" runat="server" class="form-control" placeholder="Semester"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:TextBox ID="txtFee" runat="server" class="form-control" placeholder="Fees"></asp:TextBox>
                          </div>
                        <div class="form-group mb-3">
                            <asp:DropDownList ID="dplLecturer" runat="server" class="form-control"><asp:ListItem>Select Lecturer</asp:ListItem></asp:DropDownList>
                        </div>
