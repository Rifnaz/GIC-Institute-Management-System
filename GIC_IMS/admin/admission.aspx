<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admission.aspx.cs" Inherits="GIC_IMS.admin.admission" %>
...
<body>
  <div class="d-flex" id="wrapper">
    ...
    <form id="form1" runat="server">
        <div class="container">              
                   <asp:DataList ID="dtl_admission" runat="server" RepeatColumns="3" CellPadding="0" CellSpacing="0"> 
                        <ItemTemplate>
                           <div class="addmision_list">
                            <div class="row"> 
                               <a  href="admission_details.aspx?id=<%#Eval("AdmissionID")%>">
                                <div class="col">
                                    <div class="addmission-list">
