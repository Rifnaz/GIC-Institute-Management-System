<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lecturer.aspx.cs" Inherits="GIC_IMS.admin.Lecturer" %>
                ...
                <div class="col-sm-6 col-md-9">
                    <div class="table-responsive">
                        <div class="table-wrapper">			
                            <table >
                                <asp:DataList class="table" ID="dtlLecture" RepeatColumns="7" runat="server">
                                    <HeaderTemplate>
                                        <tr>
                                    ...
                                    <ItemTemplate>
                                            ...
                                            <tr>
                                                ...
                                                <td><%#Eval("Password") %></td>
                                                <td>
                                                    <asp:LinkButton ID="lbtnView" runat="server" class="view" CommandArgument='<%#Eval("LecturerID") %>' title="View" data-toggle="tooltip" OnClick="lbtnView_Click"><i class="material-icons">&#xe8f4;</i></asp:LinkButton>
                                                    <asp:LinkButton ID="lbtnEdit" runat="server" class="edit" CommandArgument='<%#Eval("LecturerID") %>' title="Edit" data-toggle="tooltip" OnClick="lbtnEdit_Click"><i class="material-icons">&#xE254;</i></asp:LinkButton>
                                                    <asp:LinkButton ID="lbtnDelete" runat="server" class="delete" CommandArgument='<%#Eval("LecturerID") %>' title="Delete" data-toggle="tooltip" OnClick="lbtnDelete_Click"><i class="material-icons">&#xE872;</i></asp:LinkButton>
                                                </td>
                                            </tr>       
                                     </ItemTemplate>
                                </asp:DataList>
                  ...
                  <div class="col-sm-6 col-md-3 form-section">
                    <div class="login-wrapper">
                        ...
                        <div class="form-group mb-3">
                            <asp:DropDownList ID="dplQual" runat="server" class="form-control">
                        ...
                        <div class="form-group mb-3">
                            <asp:TextBox ID="txtField" runat="server" class="form-control" placeholder="Field"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:TextBox type="tel" pattern="07[1,2,5,6,7,8][0-9]{7}" maxlength="10" ID="txtPhone" runat="server" class="form-control" placeholder="Phone No"></asp:TextBox>
                        </div>
                        <div class="form-group mb-3">
