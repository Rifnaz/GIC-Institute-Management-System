<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inquiry_details.aspx.cs" Inherits="GIC_IMS.admin.Inquiry_details" %>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Inquiry Details</h2>
                </div>
            ...
            <form id="form1" runat="server">
                <div id="popup1" class="verlay">
                    <div class="opup">
                        <a class="close" href="admindash.aspx"> < Back </a><br/><br/>
                        <div class="content">
                            <div class="row">
                                <div class="col-5">
                                    ...
                                    <asp:TextBox ID="txtName" runat="server" class="form-control" type="text" disabled ></asp:TextBox>
                                    </div>

                                    <div class="form mb-3">
                                    <label for="emailAddress">Email Address</label>
                                    <asp:TextBox ID="txtMail" runat="server"  class="form-control" type="email" disabled></asp:TextBox>
                                    </div>

                                    <div class="form mb-3">
                                    <label for="phoneNo">Phone No</label>
                                    <asp:TextBox ID="txtPhone" runat="server"  class="form-control" type="number" disabled></asp:TextBox>
                                    </div>

                                    <div class="form mb-3">
                                    <label for="message">Message</label>
                                    <textarea id="txtMess" runat="server" cols="61" rows="8" disabled></textarea>
                                    </div>
                                </div>
                            
                                <div class="col-5">
                                    <div class="h3 fw-light">Send Reply Mail</div>

                                    <div class="form mb-3">
                                    <label for="title">Subject</label>
                                    <asp:TextBox ID="txtSbj" runat="server"  class="form-control" type="text"></asp:TextBox>
                                    </div>
    
                                    <div class="form mb-3">
                                    <label for="body">Body</label>
                                    <textarea id="txtBody" runat="server" cols="61" rows="8"></textarea>
                                    </div>

                                    <asp:Label ID="lblError" runat="server" Text=""></asp:Label>
                                    <div class="d-grid">
                                        <asp:Button ID="btnSent" class="btn btn-primary btn-lg" runat="server" Text="Send Reply" OnClick="btnSent_Click"/>
                                    </div>
                                    <br />
                                    <div class="d-grid">
                                        <asp:Button ID="btnDecline" class="btn btn-danger btn-lg" runat="server" Text="Decline" OnClick="btnDecline_Click"/>
                                    </div>
                                </div>
                            </div>
                        </div>
