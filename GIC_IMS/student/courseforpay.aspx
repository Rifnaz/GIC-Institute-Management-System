<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="courseforpay.aspx.cs" Inherits="GIC_IMS.student.courseforpay" %>
         ...
         <form id="form1" runat="server">
            <div class="container">
                ...
                <asp:DataList class="table" ID="dtlcoursefee" RepeatColumns="1" runat="server">
                    <ItemTemplate>
                        <a href="stn-courses.aspx?id=<%#Eval("AdmissionID") %>">
                            <div class="card">
                                <div class="card-header"><h4><%#Eval("Applyfor") %></h4></div>
                                <div class="card-body">
                                <h5 class="card-title">Fee: <%#Eval("fee") %></h5>                                
                                </div>
                            </div>
                           </a>
                     </ItemTemplate>
