<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lec-course.aspx.cs" Inherits="GIC_IMS.lecturer.lec_course" %>
    ...
    <form id="form1" runat="server">
       <div class="container">
           ...
           <div class="row-sort d-flex">
                    <asp:Label ID="Label1" runat="server" Text="Sort By Batch :"></asp:Label>
                    <asp:DropDownList ID="dplsortBatch" runat="server" OnSelectedIndexChanged="dplsortBatch_SelectedIndexChanged"  AutoPostBack="true" ></asp:DropDownList>
           ...
           <br /><br />
            <div class="row"> 
                   <asp:DataList ID="dtl_Student" runat="server" RepeatColumns="3" CellPadding="0" CellSpacing="0"> 
                        <ItemTemplate>
                           <div class="ss">                           
                               <a  href="lec-student.aspx?id=<%#Eval("StudentID")%>">
